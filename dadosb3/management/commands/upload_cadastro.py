...
from dadosb3.views import ingest_cadastro

class Command(BaseCommand):
    help = 'Faz o upload do arquivo de cadastro de instrumentos'
    ...
    def handle(self, *args, **options):
        ...
        import threading
        thread = threading.Thread(target=ingest_cadastro, args=(file_path, task_id, filename))
        thread.start()
        ...
        summary = cache.get(f'task_{task_id}_summary_txt')
        if summary:
