...
from dadosb3.views import ingest_posicoes

class Command(BaseCommand):
    help = 'Faz o upload do arquivo de posições abertas'
    ...
    def handle(self, *args, **options):
        ...
        import threading
        thread = threading.Thread(target=ingest_posicoes, args=(file_path, task_id, filename))
        thread.start()
